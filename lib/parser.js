...
function parser(menuSource) {
    if (!menuSource) throw new Error('Uwwndefined menu source');
    ...
    const dateLong = orderDate[2].trim();
    const datecode = Datecode.fromLongDate(dateLong);
